                ...
                {FAQData.map((info) => (
                    <details className="w-full [&_svg]:open:-rotate-90" key={info.question}>
                        <summary className="flex flex-row justify-between cursor-pointer hover:bg-gray-100 items-center rounded-full ">
                            ...
                            <svg className="w-[32px] h-[32px] p-1 mr-2 rotate-0 transform transition-all duration-300" fill="#000000" height="200px" width="200px" version="1.1" id="Icons" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" xml:space="preserve">
