...
const Login = () => {
  return (
    <section className='w-full py-10 mb-8 max-w-screen-wide max-container'>
      <div className='w-[75%] h-[750px] bg-white m-auto flex justify-center items-center rounded-lg shadow-2xl shadow-gray-800'>
          ...
          <div className='flex justify-center flex-col gap-12'>
            ...
            <form action="" className='flex flex-col justify-center gap-5 '>
              ...
              <p className=''>
                ...
                <span className='font-palanquin text-blue-800 font-semibold hover:underline hover:cursor-pointer px-2'>
                  Create one now
                </span>
              </p>
            </form>
